...
if (!isset($_SESSION['instID'])) header("location:../");
...
<head>
    ...
    <title>Institution Admin | KYC Portal</title>
</head>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php"> <i class="fas fa-file-invoice    "></i> Reports</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="users.php"><i class="fa fa-users" aria-hidden="true"></i> Users</a>
                </li>
                 <li class="nav-item">
